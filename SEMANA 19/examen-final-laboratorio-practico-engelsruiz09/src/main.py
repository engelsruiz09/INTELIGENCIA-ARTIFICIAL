...
class HRDataPipeline:
    ...
    def detect_feature_types(self, dataset):
        """Deteccion automatica de tipos de caracteristicas"""
    ...
    def clean_missing_values(self, data):
        ...
        # Limpieza categorica: usar estrategia de frecuencia
        for feature in cat_features:
            if feature in cleaned_data.columns:
                # Rellenar con el valor mas frecuente o crear categoria especial
        ...
        # Limpieza numerica: usar interpolacion inteligente
    ...
    def transform_categorical_data(self, dataset: pd.DataFrame, fit_encoders: bool = True) -> pd.DataFrame:
        """Transformacion optimizada de datos categoricos"""
        ...
        # Concatenar: numericas + *categoricas codificadas en entero* + one-hot
...
class MLModelFactory:
    """Factory para creacion y entrenamiento de modelos ML"""
    ...
    def build_svm_model(self, X_data, y_data):
        ...
        # Configuracion personalizada para SVM
        svm_config = {
        ...
        # Almacenar modelo y configuracion
    ...
    def build_perceptron_model(self, X_data, y_data):
        """Constructor de modelo Perceptron optimizado"""
        # Configuracion personalizada para Perceptron
        perceptron_config = {
            'max_iter': 1000,
            'random_state': RANDOM_STATE,
            'class_weight': 'balanced'
    ...
    def build_neural_network_model(self, X_data, y_data, input_dim):
        ...
        # Capas ocultas con regularizacion
        ...
        # Entrenar con configuracion personalizada
...
class PerformanceAnalyzer:
    ...
    def compute_metrics(self, true_labels, predicted_labels):
        """Calculo detallado de metricas de rendimiento"""
        performance_metrics = {}
    ...
    def analyze_model_performance(self, model_name, true_labels, predictions):
        """Analisis completo de rendimiento de un modelo"""
    ...
    def generate_performance_report(self):
        ...
        # Reordenar columnas segun especificaciones
...
def main():
    """Funcion principal del sistema de analisis HR"""
    ...
    # FASE 2: Preparacion para Entrenamiento
    print("\nFASE 2: Preparacion para Entrenamiento")
    ...
    # Preparar conjunto de prueba (no tiene target, pero necesitamos simular evaluacion)
    # Para fines de evaluacion, usaremos una division 70-30 del conjunto de entrenamiento
    ...
    # Entrenar Perceptron
    print("   Entrenando modelo Perceptron...")
    ...
    # FASE 4: Evaluacion y Predicciones
    ...
    print("\nFASE 5: Generacion de Reportes Finales")
    ...
    try:
        ...
        print(f"Reporte de evaluacion guardado en: {report_path}")
    except PermissionError:
    ...
    print("\n Analisis HR Analytics completado exitosamente!")
